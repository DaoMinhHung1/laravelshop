...
<body>
        ...
        <div class="row">
            <div class="col-12 p-0 animated-slide-banner">
                <div class="owl-carousel">
                    <div class="item">
                        <img src="/Frontend/img/banner2.webp" class="" alt="">
                    </div>
                    <div class="item">
                        <img src="/Frontend/img/banner3.webp" class="" alt="">
                    </div>
                    <div class="item">
                        <img src="/Frontend/img/banner4.webp" class="" alt="">
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row ">
            <div class="col-3 cardreview">
                <div class="itemcardreview">
                    ...
                    <h5><strong>Extra Shipping</strong></h5>
    ...
    <div class="container">
        <div class="row mt-5">
            <div class="col titletrendinghome">
                <h1 class="mt-3 fw-bold">Best Selling</h1>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col">
                <ul class="d-flex">
                    ...
                    <a href="#">
                        <li class="ms-3 me-3 fw-bold">{{ $category->name }}</li>
                    </a>
                    @endforeach
                </ul>
            </div>
            ...
            <div class="col-sm-1 col-md-4 col-lg-3 mt-3 canhsanphamtrangchu">
                <div class="card zoom-card">
                    <div class="img-container">
                        <?php $imgpd = json_decode($product->imgproduct); ?>
                        <img src="{{ asset('storage/images/products/' . $imgpd[0]) }}" class="imgchinhsp" alt="">
                    </div>
                    <div class="card-body">
